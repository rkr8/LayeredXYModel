...
SIM_STEPS=600000
SWAP_INTERVAL=100
OBSERVABLES="energy mag2 mag_layer mag_phase_diff"
NUM_BETAS=12
NUM_CONFIGS=500

SAVE_DIR="$SCRATCH/final_runs_measurements_josephson/$DELTA"
CONFIG_DIR="$SCRATCH/final_runs_configs_josephson/$DELTA"
